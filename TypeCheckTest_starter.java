...
class TypeCheckTest_starter {
	...
	@Test
	void test0C() throws PLCException{
...
""";
	...
	@Test
	void test1C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				int f(int xx, string ss, image ii, pixel p){}
""";
	...
	@Test
	void test2C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				string f(int f){}
""";
	...
	@Test
	void test3C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				string f(int f, string s){
				  int g.
...
""";
			...
			NameDef v5 = v2.get(1);
			assertThat("",v5,instanceOf(NameDef.class));
			checkNameDef(v5,"s_0",Type.STRING);
			assertNull(v5.getDimension());
			...
			checkNameDef(v12,"ss_0",Type.STRING);
	...
	@Test
	void test4C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				int f(){
				:3.
...
""";
	...
	@Test
	void test5C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				image f(){
				image i = "url".
...
""";
			...
			checkNameDef(v8,"i_0",Type.IMAGE);
			...
			checkNameDef(v14,"rr_0",Type.INT);
	...
	@Test
	void test6C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				image f(){
				image i = "url".
...
""";
	...
	@Test
	void test7C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
void f(string url){
				image[300,400] i = url.
...
""";
			...
			NameDef v4 = v2.get(0);
			assertThat("",v4,instanceOf(NameDef.class));
			checkNameDef(v4,"url_0",Type.STRING);
			assertNull(v4.getDimension());
			Block v5 = v0.getBlock();
			assertThat("",v5,instanceOf(Block.class));
			List<Declaration> v6 = v5.getDecList();
			...
			checkNameDef(v9,"i_0",Type.IMAGE);
			...
			checkNameDef(v15,"j_0",Type.IMAGE);
			...
			checkIdentExpr(v39,"j_0");
			assertEquals(Type.IMAGE, v39.getType());
		});
	}

	@Test
	void test8C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
string s(string s0, string s1, int ok){
				:if ok ? s0 ? s0 + s1 .
...
""";
			...
			NameDef v4 = v2.get(0);
			assertThat("",v4,instanceOf(NameDef.class));
			checkNameDef(v4,"s0_0",Type.STRING);
			assertNull(v4.getDimension());
			NameDef v5 = v2.get(1);
			assertThat("",v5,instanceOf(NameDef.class));
			checkNameDef(v5,"s1_0",Type.STRING);
			assertNull(v5.getDimension());
			NameDef v6 = v2.get(2);
			assertThat("",v6,instanceOf(NameDef.class));
			checkNameDef(v6,"ok_0",Type.INT);
			assertNull(v6.getDimension());
...
""";
			...
			checkIdentExpr(v15,"xx_0");
			assertEquals(Type.INT, v15.getType());
		});
	}

	@Test
	void test10C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				int f(int xx){
				int i = 3.
...
""";
			...
			checkIdentExpr(v31,"i_0");
			assertEquals(Type.INT, v31.getType());
		});
	}

	@Test
	void test11C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
				int f(int xx){
				int i = 3.
...
""";
			...
			checkNameDef(v21,"xx_1",Type.STRING);
			...
			checkNameDef(v45,"xx_2",Type.IMAGE);
			...
			checkIdentExpr(v58,"i_0");
			assertEquals(Type.INT, v58.getType());
		});
	}

	@Test
	void test12C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
int f() {
    int xx = 2.
...
""";
			...
			checkIdentExpr(v14,"xx_0");
			assertEquals(Type.INT, v14.getType());
		});
	}

	@Test
	void test13C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
int f() {
    int xx = 2.
...
""";
	...
	@Test
	void test14C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
int f() {
    int xx = 2.
...
""";
	...
	@Test
	void test15C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
int f() {
    int xx = 2.
...
""";
	...
	@Test
	void test16C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
int f() {
    int xx = 2.
...
""";
			...
			NameDef v11 = v10.getNameDef();
			assertThat("",v11,instanceOf(NameDef.class));
			checkNameDef(v11,"ab_0",Type.IMAGE);
			...
			checkIdentExpr(v31,"xx_0");
			assertEquals(Type.INT, v31.getType());
		});
	}

	@Test
	void test17C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
int f() {
    int xx = rand.
...
""";
			...
			assertThat("",v12,instanceOf(ReturnStatement.class));
			Expr v13 = ((ReturnStatement)v12).getE();
			checkIdentExpr(v13,"xx_0");
			assertEquals(Type.INT, v13.getType());
		});
	}

	@Test
	void test18C() throws PLCException{
		assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
			String input = """
pixel f() {
    image[200,200] ab.
...
""";
			...
			NameDef v8 = v7.getNameDef();
			assertThat("",v8,instanceOf(NameDef.class));
			checkNameDef(v8,"ab_0",Type.IMAGE);
			...
			checkNameDef(v13,"xx_0",Type.INT);
...
""";
			...
			NameDef v11 = v10.getNameDef();
			assertThat("",v11,instanceOf(NameDef.class));
			checkNameDef(v11,"yy_0",Type.INT);
			assertNull(v11.getDimension());
			Expr v12 = v10.getInitializer();
			checkNumLit(v12,3);
			assertEquals(Type.INT, v12.getType());
			...
			assertEquals(Type.INT, v16.getType());
			Expr v17 = ((BinaryExpr)v16).getLeft();
			checkIdentExpr(v17,"xx_0");
			assertEquals(Type.INT, v17.getType());
			Expr v18 = ((BinaryExpr)v16).getRight();
			checkIdentExpr(v18,"yy_0");
			assertEquals(Type.INT, v18.getType());
		});
	}
...
""";
			...
			NameDef v13 = v12.getNameDef();
			assertThat("",v13,instanceOf(NameDef.class));
			checkNameDef(v13,"image1_0",Type.IMAGE);
			...
			checkNameDef(v18,"image2_0",Type.IMAGE);
			...
			checkNameDef(v23,"bb_0",Type.INT);
			...
			checkIdentExpr(v25,"image1_0");
			assertEquals(Type.IMAGE, v25.getType());
			Expr v26 = ((BinaryExpr)v24).getRight();
			checkIdentExpr(v26,"image2_0");
			...
			checkNameDef(v28,"cc_0",Type.INT);
			...
			checkNameDef(v41,"dd_0",Type.INT);
...
""";
			...
			NameDef v13 = v12.getNameDef();
			assertThat("",v13,instanceOf(NameDef.class));
			checkNameDef(v13,"bb_0",Type.IMAGE);
			Dimension v14 = ((NameDef)v13).getDimension();
			assertThat("",v14,instanceOf(Dimension.class));
			Expr v15 = ((Dimension)v14).getWidth();
			checkNumLit(v15,200);
			...
			NameDef v18 = v17.getNameDef();
			assertThat("",v18,instanceOf(NameDef.class));
			checkNameDef(v18,"cc_0",Type.INT);
...
""";
			...
			NameDef v18 = v17.getNameDef();
			assertThat("",v18,instanceOf(NameDef.class));
			checkNameDef(v18,"cc_0",Type.STRING);
			assertNull(v18.getDimension());
			Expr v19 = v17.getInitializer();
...
""";
			...
			NameDef v10 = v9.getNameDef();
			assertThat("",v10,instanceOf(NameDef.class));
			checkNameDef(v10,"bb_0",Type.IMAGE);
			...
			assertEquals(Type.INT, v19.getType());
			Expr v20 = ((BinaryExpr)v19).getLeft();
			checkIdentExpr(v20,"aa_0");
			assertEquals(Type.INT, v20.getType());
			Expr v21 = ((BinaryExpr)v19).getRight();
			checkIdentExpr(v21,"aa_0");
			assertEquals(Type.INT, v21.getType());
			...
			Expr v43 = ((BinaryExpr)v42).getLeft();
			checkIdentExpr(v43,"bb_0");
			assertEquals(Type.IMAGE, v43.getType());
			Expr v44 = ((BinaryExpr)v42).getRight();
			checkIdentExpr(v44,"bb_0");
			assertEquals(Type.IMAGE, v44.getType());
		});
	}
...
""";
			...
			NameDef v8 = v7.getNameDef();
			assertThat("",v8,instanceOf(NameDef.class));
			checkNameDef(v8,"aa_0",Type.IMAGE);
			Dimension v9 = ((NameDef)v8).getDimension();
			assertThat("",v9,instanceOf(Dimension.class));
			Expr v10 = ((Dimension)v9).getWidth();
			checkNumLit(v10,200);
...
""";
			...
			checkNameDef(v20,"cc_0",Type.INT);
