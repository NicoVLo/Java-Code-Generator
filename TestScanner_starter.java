...
class TestScanner_starter {
	...
	@Test
	void singleTimes() throws LexicalException {
		String input = "*";
		IScanner scanner = CompilerComponentFactory.makeScanner(input);
		checkToken(Kind.TIMES, "*", new SourceLocation(1,1), scanner.next());
		checkEOF(scanner.next());  //repeated invocations of next after end reached should return EOF token
	}

	@Test
	void singleZero() throws LexicalException {
		String input = "0";
		IScanner scanner = CompilerComponentFactory.makeScanner(input);
		checkToken(Kind.NUM_LIT, "0", new SourceLocation(1,1), scanner.next());
		checkEOF(scanner.next());  //repeated invocations of next after end reached should return EOF token
	}
	...
	void singleCharTokens() throws LexicalException{
		...
		checkToken(Kind.TIMES, "*", new SourceLocation(1,2),scanner.next());
		checkToken(Kind.NUM_LIT, "0", new SourceLocation(1, 3), scanner.next());
		checkToken(Kind.NUM_LIT, "0", new SourceLocation(1, 4), scanner.next());
		checkEOF(scanner.next());
	}
	...
	void singleCharTokensWithWhiteSpace() throws LexicalException{
		...
		checkToken(Kind.NUM_LIT, "0", new SourceLocation(2,1),scanner.next());
		checkToken(Kind.NUM_LIT, "0", new SourceLocation(3,1),scanner.next());
		checkEOF(scanner.next());
	}
	...
	void equals() throws LexicalException{
		String input = """
			...
			*==+
			""";
		IScanner scanner = CompilerComponentFactory.makeScanner(input);
		checkToken(Kind.EQ, "==", new SourceLocation(1,1),scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(2,1),scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(2,4),scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(3,1),scanner.next());
		checkToken(Kind.TIMES, "*",new SourceLocation(3,3), scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(3,4),scanner.next());
		checkToken(Kind.TIMES, "*",new SourceLocation(4,1), scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(4,2),scanner.next());
		checkToken(Kind.PLUS, "+",new SourceLocation(4,4), scanner.next());
		checkEOF(scanner.next());
	}
	@Test
	void numLits1() throws LexicalException {
		String input = """
				...
				""";
		IScanner scanner = CompilerComponentFactory.makeScanner(input);
		checkNUM_LIT(123,new SourceLocation(1,1), scanner.next());
		checkNUM_LIT(0,new SourceLocation(2,1), scanner.next());
		checkNUM_LIT(5,new SourceLocation(2,2), scanner.next());
		checkNUM_LIT(240,new SourceLocation(3,1), scanner.next());
		checkNUM_LIT(1,new SourceLocation(4,1), scanner.next());
		checkToken(Kind.PLUS,"+",new SourceLocation(4,2), scanner.next());
		checkNUM_LIT(2,new SourceLocation(4,3), scanner.next());
	...
	void operators0() throws LexicalException {
		...
		IScanner scanner = CompilerComponentFactory.makeScanner(input);
		checkToken(Kind.EQ, "==", new SourceLocation(1,1),scanner.next());
		checkToken(Kind.PLUS, "+", new SourceLocation(2,1),scanner.next());
		checkToken(Kind.DIV, "/", new SourceLocation(3,1),scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(4,1),scanner.next());
		checkToken(Kind.EQ, "==",new SourceLocation(4,3),scanner.next());
		checkToken(Kind.ASSIGN, "=", new SourceLocation(5,1),scanner.next());
		checkToken(Kind.EQ, "==", new SourceLocation(6,1),scanner.next());
		checkToken(Kind.ASSIGN, "=", new SourceLocation(6,3),scanner.next());
		checkEOF(scanner.next());
	}
